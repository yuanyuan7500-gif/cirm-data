                    ...
                    {expandedRows.has(grant.id) && (
                      <TableRow className="bg-gray-50/50">
                        <TableCell colSpan={7} className="py-4 px-4">
                          <div className="pl-4 pr-2" style={{ maxWidth: '100%', overflow: 'hidden' }}>
                            {/* 查找该资助类型下的具体项目 */}
                            {(() => {
                                                  ...
                                                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                                                    ...
                                                    {project.detailUrl ? (
                                                      <a
                                                        ...
                                                        className="text-sm font-medium text-gray-900 break-all leading-relaxed hover:text-[#008080] hover:underline flex items-center gap-1"
                                                  ...
                                                  <div className="flex flex-wrap gap-x-4 gap-y-1 text-gray-500">
                                                    ...
                                                    {project.diseaseFocus && (
                                                      <span className="relative group cursor-help flex items-center gap-1">
                                                        ...
                                                        <span className="truncate max-w-[150px] inline-block align-bottom" title={project.diseaseFocus}>
                                                          {project.diseaseFocus}
                                                        </span>
                                                        <span className="absolute bottom-full left-0 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg whitespace-normal max-w-xs z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 shadow-lg pointer-events-none">
                                                          {project.diseaseFocus}
